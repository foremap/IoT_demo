...
DEFAULT_APP_KEY = "xxxxxx"
DEFAULT_SECRET_KEY = "ooooooo"
class TTS(object):
...
class Recognizer(AudioSource):
    ...
    def recognize_baidu(self, audio_data, language="zh", app_key=DEFAULT_APP_KEY, secret_key=DEFAULT_SECRET_KEY):
        """
        ...
        # Get Token
        token = GetToken(app_key, secret_key)

        # Get data
        convert_rate = 8000
        wmv_data = audio_data.get_wav_data(
            convert_rate=convert_rate,  # audio samples must be at least 8 kHz
        ...
        data = {
                ...
                "len": len(wmv_data),
                "rate": convert_rate,
                "speech": base64.b64encode(wmv_data),
                "cuid": '93489083242',
                "channel": 1,
            }
